...
X_PUBLISH_TOP_N    = 2
X_MAX_PER_DAY      = 2    # hard cap on live X publications per calendar day (UTC) — user 2026-06-29 (5 -> 2 on 2026-07-10)
...
MARKET_ORDER = ["FTSE 100", "FTSE 250", "NASDAQ 100", "S&P 500", "DAX", "Euronext", "SSE (Shanghai)", "Hong Kong",
                "Nikkei 225", "ASX", "NSE (India)", "BSE (India)", "SZSE (Shenzhen)", "Commodities", "Indices", "FX", "Crypto", "Government Bonds"]
